...
pipes.ClientPipe c = new pipes.ClientPipe("Demo", true);
c.connect();
Console.WriteLine(c.readNextLine());
Console.WriteLine(c.readNextLine());
Console.WriteLine(c.readNextLine());
c.close();


pipes.ServerPipe P = new pipes.ServerPipe("Demos",true);
P.connect();
P.writeStream("Hello");
P.sendStream();
P.clearStream();
P.writeStream("Hello againnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn");
P.sendStream();
P.close();
namespace pipes
{
